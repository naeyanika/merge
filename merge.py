...
st.divider()
st.caption("Catatan:")
st.caption("1. Ini digunakan untuk pivot table data N/A yang sudah di cari manual")
st.caption("2. Nama data sesuai yang di download sebelumnya tidak usah di ubah lagi dan ektensi file nya dibiarkan .xlsx")
st.caption("3. Jika hanya ada file n/a 1 atau 2 lalu di upload, kode akan tetap berjalan.")
st.divider()

st.subheader("Nama file yang harus sesuai:")
st.write("1. pinjamana_na.xlsx")
st.write("2. simpanan_na.xlsx")
st.write("3. TLP_na.xlsx")
st.write("4. KDP_na.xlsx")
